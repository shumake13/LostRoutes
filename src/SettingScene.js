var SettingLayer=cc.Layer.extend({
	ctor:function(){
		...
		var soundToggleMenuItem=new cc.MenuItemToggle(soundOnMenuItem,soundOffMenuItem,
		...
		var musicToggleMenuItem=new cc.MenuItemToggle(musicOnMenuItem,musicOffMenuItem,
